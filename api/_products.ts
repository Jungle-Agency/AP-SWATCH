...
export const products: Product[] = [
  {
    ...
    description: "Finis à la main en Suisse, ce bracelet intègre un polymère FKM de grade aérospatial offrant une résistance thermique et chimique inégalée. Conçu exclusivement pour épouser les lignes de la Royal Pop, le Noir Obsidienne évoque une élégance discrète et ténébreuse.",
    price: 100,
    originalPrice: 120,
  ...
  },
  {
    ...
    description: "Le Bleu Tangerine combine la sobriété d'un marine profond et l'audace d'inserts orange vif. Inspiré des chronographes de plongée vintage, ce bracelet apporte une touche sportive et lumineuse à votre Royal Pop.",
    price: 100,
    originalPrice: 120,
